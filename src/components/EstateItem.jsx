...
import "./EstateItem.sass";

const EstateItem = ({ estate }) => {
  return (
    <div className="estate-item">
      <div className="image">
        {/* Assuming `estate.image` is the URL of the image */}
        <img src={estate?.image} alt={`Image of ${estate?.name}`} />
      </div>
      <div className="details">

    <div className="property-status">
        <span>
            {estate?.is_rental ===1 ? "ქირავდება" : "იყიდება"}
        </span>
    </div>

        <div className="main-details-container">
          <h2 className="price">{formatPrice(estate?.price)} ₾</h2>
        ...
        <div className="secondary-details-container">
          <div className="secondary-details-item">
            <svg
              width="24"
              height="24"
              viewBox="0 0 24 24"
            ...
            <span className="bedroom-quantity">
                {estate?.bedrooms}
            </span>
          </div>
          ...
          <div className="secondary-details-item">
            ...
            <span className="size">{estate?.area} მ²</span>
          </div>
          ...
          <div className="secondary-details-item">
            ...
            <span className="zip-code">{estate?.zip_code}</span>
          </div>
        </div>
      </div>
    </div>
